...
pipe_description pipe_descriptions[NUM_PIPES] = {
	{ "\\\\.\\pipe\\libinteractive_Main_extremos_out", "\\\\.\\pipe\\libinteractive_extremos_extremos_out" },
	{ "\\\\.\\pipe\\libinteractive_extremos_extremos_in", "\\\\.\\pipe\\libinteractive_Main_extremos_in" },
};

char* const commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"libinteractive\\extremos\\extremos.exe\"",
};
char* const debug_commands[] = {
	"\"libinteractive\\Main\\Main.exe\"",
	"\"gdbserver.exe\" \"127.0.0.1:8042\" \"libinteractive\\extremos\\extremos_debug.exe\" \"--print-ready\"",
};
